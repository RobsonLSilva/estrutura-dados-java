...
public class Exercicio_007 extends Exercicio_006 {
    ...
    private static void excluirPorPosicao(BufferedReader scan, ArrayList<Contato> lista){
    ...
    private static void excluirContato(BufferedReader scan, ArrayList<Contato> lista){
    ...
    private static void pesquisarContatoExiste(BufferedReader scan, ArrayList<Contato> lista){
    ...
    private static void pesquisarUltimoIndice(BufferedReader scan, ArrayList<Contato> lista){
    ...
    private static void obtemContato(BufferedReader scan, ArrayList<Contato> lista){
    ...
    private static void obtemContatoPosicao(BufferedReader scan, ArrayList<Contato> lista){
    ...
    private static void adicionarContatoFinal(BufferedReader scan, ArrayList<Contato> lista) throws IOException {
    ...
    private static void adicionarContatoPosicao(BufferedReader scan, ArrayList<Contato> lista) throws IOException {
